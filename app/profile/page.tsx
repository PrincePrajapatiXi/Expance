...
export default function ProfilePage() {
  ...
  const handleImportSuccess = (imported: Transaction[]) => {
    ...
    setMessage(`Imported ${imported.length} transactions successfully!`);
    setTimeout(() => setMessage(null), 4000);
  };
  ...
  return (
    <div className="w-full min-h-screen overflow-x-hidden overflow-y-auto pb-28 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      <main className="max-w-4xl mx-auto w-full px-3 sm:px-4 lg:px-6 pt-2">
        ...
        {/* Import Data Card (Right next to the Export section) */}
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-200/80 dark:border-slate-800 shadow-xs mb-4">
          <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800 mb-3">
            <div className="flex items-center gap-2">
              <div className="p-2 rounded-xl bg-indigo-50 dark:bg-indigo-950/40 text-indigo-600 dark:text-indigo-400">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">Bulk import expenses and income from your existing spreadsheets</p>
              </div>
            </div>
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-indigo-50 dark:bg-indigo-950/60 hover:bg-indigo-100 dark:hover:bg-indigo-900/60 text-indigo-700 dark:text-indigo-300 font-bold text-xs border border-indigo-200/70 dark:border-indigo-800/70 transition-all cursor-pointer"
            >
          ...
          {/* Hidden File Input for Card Dropzone */}
          <input
          ...
          {/* Lightweight, clean file dropzone / button */}
          <div
            ...
            className={`border-2 border-dashed rounded-2xl p-5 text-center cursor-pointer transition-all duration-150 select-none ${
              isCardDragOver
                ? 'border-indigo-600 bg-indigo-50/70 dark:bg-indigo-950/40 scale-[1.005]'
                : 'border-slate-200 dark:border-slate-700 hover:border-indigo-500/70 bg-slate-50/50 dark:bg-slate-800/30 hover:bg-slate-50 dark:hover:bg-slate-800/60'
            }`}
          >
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-3.5 text-left">
                <div className="w-12 h-12 rounded-2xl bg-indigo-100 dark:bg-indigo-950/60 text-indigo-600 dark:text-indigo-400 flex items-center justify-center shrink-0 shadow-inner">
                  <FileSpreadsheet className="w-6 h-6" />
                </div>
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1.5 flex-wrap">
                    ...
                    <span className="text-[10px] text-slate-400 hidden md:inline">
                      • Smart auto-detects Amount, Type, Category, Date & Mode
                    </span>
                  </div>
                </div>
              </div>
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-indigo-900 hover:bg-indigo-950 text-white text-xs font-extrabold shadow-sm transition-transform active:scale-95 cursor-pointer shrink-0"
              >
                Choose File
              </button>
            </div>
