...
export default function TransactionModal({
  ...
  // Strict null guard: Never render hidden/transparent backdrop when closed
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 pointer-events-auto">
      ...
      {/* Modal Container */}
      <div
        className="relative z-10 w-full sm:max-w-lg bg-white dark:bg-slate-900 rounded-t-3xl sm:rounded-3xl p-6 shadow-2xl border border-slate-100 dark:border-slate-800 max-h-[90vh] overflow-y-auto animate-in slide-in-from-bottom duration-200"
      >
